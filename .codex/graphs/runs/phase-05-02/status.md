...
| DATABASE | Agent 2 Database Engineer | DOMAIN PASS | `codex/p5-02-database` / `.worktrees/p5-02-database` | `prisma/**`, `packages/database/**`, database contract; sole Phase 5.2 migration | READY | 2026-08-25 | | Root + QA/adversarial | `database-contract.md` |
| SECURITY | Agent 3 Security Engineer | DOMAIN PASS | `codex/p5-02-security` / `.worktrees/p5-02-security` | CRM permission semantics, authorization implementation/tests, authorization contract; no seed writes until DB handoff | READY | 2026-08-25 | | Root + post-integration security review | `authorization-contract.md` |
