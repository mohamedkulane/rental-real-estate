...
| GOV-001 | HIGH | All independent review gates must be complete before a durable PASS | Native CRM integration evidence is now PASS (QA 5/5), but `ux-findings.md` still records the required 1440/768/390 responsive browser review as NOT RUN. | FAIL | Complete and record live responsive review at all required viewports, then rerun governance. | Pending responsive evidence |
