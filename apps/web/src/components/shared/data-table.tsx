  ...
  return (
    <label className="relative block min-w-0 flex-1">
      ...
      <input
        ...
        className="w-full rounded-md border border-slate-200 bg-white py-2 pl-10 pr-3 text-[14px] text-slate-800 shadow-sm transition focus:border-[var(--primary)] focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/15"
      />
    </label>
  );
}
